...
{
    public class WeatherForecastDataManager
    {
        readonly RequestManager _currentRequestManager;
        SQLAzureDataContext _currentContext;

        public WeatherForecastDataManager(RequestManager requestManager)
        {
